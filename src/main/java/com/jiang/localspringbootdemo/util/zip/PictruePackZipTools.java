...
public class PictruePackZipTools {
    ...
    public static void main(String[] args) throws IOException {
        ...
        urls.put("微仓A布局图","https://j-image.missfresh.cn/1579157121105-870.png");
        urls.put("微仓B布局图","https://j-image.missfresh.cn/1579157121105-870.png");
        File file = new File("/Users/jiangqb/Desktop/temp/test.zip");
        FileOutputStream fileOutputStream = new FileOutputStream(file);
        compressZip(urls,fileOutputStream,"UTF-8",false);
