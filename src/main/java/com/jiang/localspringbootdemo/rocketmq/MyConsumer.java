package com.jiang.localspringbootdemo.rocketmq;
...
public class MyConsumer {
     ...
     * nameSrv IP及端口
     */
    private String nameSrv = "localhost:9876";
    ...
    public MyConsumer() throws MQClientException {
        ...
        consumer.registerMessageListener((MessageListenerConcurrently) (msgs, context)->{
            try{
                ...
                final String s = JSONObject.toJSONString(message);
